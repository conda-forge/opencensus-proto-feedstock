...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opencensus-proto-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13885&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opencensus-proto-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opencensus-proto` can be installed with:

```
conda install opencensus-proto
```

It is possible to list all of the versions of `opencensus-proto` available on your platform with:
